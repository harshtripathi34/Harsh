...
const ExclusiveOffers = ({foodName,foodImage,discountPercent,}) => {
  return (
    <div style={{backgroundImage:`linear-gradient(to bottom, transparent,rgba(0,0,0,0.6)),url(${foodImage})`,backgroundSize:'cover' ,backgroundPosition:'center'}} className='h-[300px] flex-1 min-w-[200px] rounded-lg flex flex-col items-start justify-end px-4 py-4 relative overflow-hidden'>
